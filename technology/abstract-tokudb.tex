...
high-performance\index{high-performance} in write-intensive environments. It
uses fractal-tree index\index{fractal-tree} data structure, that keeps the data
...
Percona\index{Percona} server~\cite{hid-sp18-516-www-wiki-tokudb}. The use of
