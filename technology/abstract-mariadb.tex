...
developed to be an enhanced, drop-in replacement\index{replacement} for
MySQL~\cite{hid-sp18-516-www-mariadb-foundation}. It is available in Debian and
Ubuntu, and is now the default database on many Linux\index{Linux}
...
version 10.2, MariaDB uses InnoDB\index{InnoDB} as the default storage
