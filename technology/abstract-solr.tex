...
Apache Solr is a fast, open-source search platform\index{search platform} used
to build search applications. It leverages the power of Apache
Lucene\index{Lucene}, which is a Java-based search library providing the core
...
regular releases. Solr has RESTful\index{restful} API's like HTTP/XML or JSON to
