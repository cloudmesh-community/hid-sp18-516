...
\textit{Cascading}\index{Cascading}, a stand-alone open source Java application
...
SQL\index{ANSI-SQL} interface allows SQL users to utilize their existing SQL
skills to access data locked on the Hadoop\index{Hadoop} clusters, thereby
