...
Jaspersoft is a Business Intelligence (BI)\index{BI} platform that provides its
...
software\index{reporting software} is designed to take input from one or more
...
JasperReports\index{JasperReports} is an open source reporting tool that can be
